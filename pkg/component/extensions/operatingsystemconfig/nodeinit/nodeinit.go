...
// ContainersCABundle is an alias for the imagevector.ContainersCABundle. Exposed for testing.
var ContainersCABundle = imagevector.ContainersCABundle
...
func Config(
	...
	registryCAEnabled := ContainersCABundle() != nil
