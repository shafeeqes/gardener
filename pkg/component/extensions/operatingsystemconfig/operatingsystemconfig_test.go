...
var _ = Describe("OperatingSystemConfig", func() {
	Describe("> Interface", func() {
		...
		var (
			...
			//nolint:unparam
			initConfigFn = func(worker gardencorev1beta1.Worker, nodeAgentImage string, config *nodeagentconfigv1alpha1.NodeAgentConfiguration, _ bool) ([]extensionsv1alpha1.Unit, []extensionsv1alpha1.File, error) {
...
`))
			...
			It("should exclude the bootstrap token file if purpose is not provision", func() {
				...
				initConfigFnWithBootstrapToken := func(worker gardencorev1beta1.Worker, nodeAgentImage string, config *nodeagentconfigv1alpha1.NodeAgentConfiguration, registryCAEnabled bool) ([]extensionsv1alpha1.Unit, []extensionsv1alpha1.File, error) {
					units, files, err := initConfigFn(worker, nodeAgentImage, config, registryCAEnabled)
