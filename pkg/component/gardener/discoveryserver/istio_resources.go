...
func (g *gardenerDiscoveryServer) istioResources() ([]client.Object, error) {
	...
	gateway := &istionetworkingv1beta1.Gateway{Name: deploymentName, Namespace: g.namespace}
	...
	virtualService := &istionetworkingv1beta1.VirtualService{Name: deploymentName, Namespace: g.namespace}
	...
	destinationRule := &istionetworkingv1beta1.DestinationRule{Name: deploymentName, Namespace: g.namespace}
