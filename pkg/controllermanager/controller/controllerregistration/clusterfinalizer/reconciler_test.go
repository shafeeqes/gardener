...
var _ = Describe("Reconciler", func() {
	...
	Context("for Seeds", func() {
		...
		Describe("#Reconcile", func() {
			It("should return nil because object not found", func() {
				result, err := reconciler.Reconcile(ctx, reconcile.Request{Name: seedName})
	...
	Context("for Shoots", func() {
		...
		Describe("#Reconcile", func() {
			It("should return nil because object not found", func() {
				result, err := reconciler.Reconcile(ctx, reconcile.Request{Name: shootName, Namespace: shootNamespace})
				Expect(result).To(Equal(reconcile.Result{}))
				Expect(err).NotTo(HaveOccurred())
			})
