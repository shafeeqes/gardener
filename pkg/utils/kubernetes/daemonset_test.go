...
var _ = Describe("DaemonSet", func() {
	DescribeTable("#PodManagedByDaemonSet", func(ownerRefs []metav1.OwnerReference, expectedResult bool) {
		...
		Entry("DaemonSet is owner but not controller", []metav1.OwnerReference{{APIVersion: "apps/v1", Kind: "DaemonSet", Controller: new(false)}}, false),
		Entry("DaemonSet is owner and controller", []metav1.OwnerReference{{APIVersion: "apps/v1", Kind: "DaemonSet", Controller: new(true)}}, true),
		Entry("DaemonSet and other ref are owners", []metav1.OwnerReference{{}, {APIVersion: "apps/v1", Kind: "DaemonSet", Controller: new(true)}}, true),
	)
})
